...
1. **Feature-Based First**: Código específico de uma funcionalidade reside exclusivamente na sua pasta de feature (`src/features/<feature-name>`). As rotas em `src/routes/` devem ser estritamente _Thin Controllers_.
...
_Governança mantida pelo time de engenharia e arquitetura da Meridian Tech._
