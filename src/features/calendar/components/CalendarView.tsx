  ...
  return (
    ...
    >
                    ...
                    <div className="space-y-2 min-w-0 flex-1">
                      ...
                      <div className="flex items-center gap-4 text-xs text-muted-foreground flex-wrap">
                        ...
                        <span className="flex items-center gap-1 dado font-mono text-foreground">
                          ...
                          {new Date(r.data + "T12:00:00").toLocaleDateString("pt-BR")} às{" "}
                          {r.horario} ({r.duracao_minutos} min)
                        </span>
                      </div>
      ...
      <ConfirmDeleteDialog
        ...
        itemNome={
          reuniaoParaExcluir
            ? `${reuniaoParaExcluir.titulo} (${reuniaoParaExcluir.empresa_nome || ""}) - ${reuniaoParaExcluir.data} às ${reuniaoParaExcluir.horario}`
            : undefined
        }
