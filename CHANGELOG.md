...
- **Rotas Finas (_Thin Controllers_)**: Simplificação de todas as rotas em `src/routes/` para controladores enxutos que delegam a renderização para suas respectivas `<FeatureView />`.
