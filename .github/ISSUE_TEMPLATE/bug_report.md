...
about: "Relate um comportamento inesperado ou erro no Meridian Hub"
title: "[BUG] "
labels: ["bug", "triage"]
assignees: ""
---
...
- [ ] `leads` (Base de Estabelecimentos / Detalhes)
- [ ] `pipeline` (Funil de Vendas Kanban)
- [ ] `prospecting` (Scanner Google Places / Histórico de Buscas)
- [ ] `users` (Gestão de Equipe / Auditoria)
- [ ] Outro: `___________`
