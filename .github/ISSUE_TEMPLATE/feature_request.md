...
about: "Sugira uma nova funcionalidade ou melhoria para o Meridian Hub"
title: "[FEAT] "
...
- [ ] `leads` (Enriquecimento de Dados / Ficha)
- [ ] `pipeline` (Funil de Vendas Kanban)
- [ ] `prospecting` (Mineração / Integração Google Places)
- [ ] `users` (Gestão de Equipe & Produtividade)
- [ ] Outro
